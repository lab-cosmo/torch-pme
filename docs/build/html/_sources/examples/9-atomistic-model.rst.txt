...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_9-atomistic-model.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_9-atomistic-model.py:
...
.. chemiscope:: _datasets/fig_9-atomistic-model_003.json.gz
            :mode: structure
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/philiploche/repos/lab-cosmo/torch-pme/examples/9-atomistic-model.py:136: UserWarning: custom data 'charges' is experimental, please contact metatensor's developers to add this data as a member of the `System` class (Triggered internally at /Users/runner/work/metatensor/metatensor/metatensor-torch/src/atomistic/system.cpp:868.)
      print(system.get_data("charges").values)
    tensor([[1.],
            [1.],
            [1.],
...
.. GENERATED FROM PYTHON SOURCE LINES 153-245
...
.. GENERATED FROM PYTHON SOURCE LINES 246-270
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/philiploche/repos/lab-cosmo/torch-pme/.tox/docs/lib/python3.12/site-packages/ase/md/md.py:53: FutureWarning: Specify the temperature in K using the 'temperature_K' argument
...
.. chemiscope:: _datasets/fig_9-atomistic-model_004.json.gz
            :mode: structure
...
.. image-sg:: /examples/images/sphx_glr_9-atomistic-model_001.png
   :alt: 9 atomistic model
   :srcset: /examples/images/sphx_glr_9-atomistic-model_001.png
...
.. GENERATED FROM PYTHON SOURCE LINES 454-460
...
.. GENERATED FROM PYTHON SOURCE LINES 460-497
...
.. GENERATED FROM PYTHON SOURCE LINES 499-523
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Energy (Ewald): -52.210487365722656
    Energy (PME):   -52.16450500488281
    Energy (P3M):   -52.16064453125

    Forces(Ewald):
    [[-0.93467945 -0.41486141  0.03855323]
     [-0.36074385 -0.23255639  0.10333809]
     [-0.09952284  0.60581988 -0.87559938]
     [ 0.50091654 -0.11496626 -0.14971663]
     [-1.08569944 -0.16617619 -0.78311718]
     [ 0.4266997  -0.36797547 -0.07830646]
     [ 0.27562129 -0.27949116 -0.01128741]
     [ 1.26560318 -0.39468488  1.04621589]
     [-0.63140863  0.77128899  0.5765419 ]
     [ 1.08085787  0.23547387  0.34941414]
     [-0.51170689  0.32088208 -0.16284481]
     [ 0.07405304  0.03724709 -0.05319194]]
    Forces (PME):
    [[-0.92804366 -0.41778877  0.04636545]
     [-0.36558846 -0.22443768  0.11196633]
     [-0.09541021  0.60108715 -0.87226546]
     [ 0.50947863 -0.12210899 -0.15730669]
     [-1.09248459 -0.15841787 -0.77580267]
     [ 0.43407288 -0.36456677 -0.07337991]
     [ 0.26736337 -0.28267112 -0.01023089]
     [ 1.27222455 -0.4008815   1.05172193]
     [-0.6297791   0.76598811  0.5682795 ]
     [ 1.08687973  0.22715537  0.34302801]
     [-0.51168108  0.32808006 -0.15445282]
     [ 0.06821397  0.0312401  -0.05393113]]
    Forces (P3M):
    [[-0.93390942 -0.41543767  0.03898459]
     [-0.36162564 -0.23222244  0.1035781 ]
     [-0.09873701  0.60498124 -0.87501645]
     [ 0.50106359 -0.11560531 -0.15033236]
     [-1.0865308  -0.16557109 -0.78256649]
     [ 0.42750022 -0.36726639 -0.07747971]
     [ 0.27512762 -0.28006291 -0.01100629]
     [ 1.26642203 -0.39551637  1.04714537]
     [-0.63099486  0.77039355  0.5762831 ]
     [ 1.08170116  0.23518655  0.34851733]
     [-0.51173419  0.32154244 -0.16274978]
     [ 0.07323302  0.03636205 -0.05333308]]
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 11.064 seconds)


.. _sphx_glr_download_examples_9-atomistic-model.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: 9-atomistic-model.ipynb <9-atomistic-model.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: 9-atomistic-model.py <9-atomistic-model.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: 9-atomistic-model.zip <9-atomistic-model.zip>`
