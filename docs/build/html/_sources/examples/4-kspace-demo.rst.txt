...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_4-kspace-demo.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_4-kspace-demo.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/philiploche/repos/lab-cosmo/torch-pme/examples/4-kspace-demo.py:49: DeprecationWarning: __array_wrap__ must accept context and return_scalar arguments (positionally) in the future. (Deprecated NumPy 2.0)
      np.exp(-4 * ((cell[0, 0] / 2 - xyz_mesh) ** 2)[..., :2].sum(axis=-1))
...
.. image-sg:: /examples/images/sphx_glr_4-kspace-demo_001.png
   :alt: input values, filtered
   :srcset: /examples/images/sphx_glr_4-kspace-demo_001.png
...
.. chemiscope:: _datasets/fig_4-kspace-demo_001.json.gz
            :mode: structure
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/philiploche/repos/lab-cosmo/torch-pme/examples/4-kspace-demo.py:191: DeprecationWarning: __array_wrap__ must accept context and return_scalar arguments (positionally) in the future. (Deprecated NumPy 2.0)
      np.exp(-4 * ((cell[0, 0] / 2 - xyz_mesh) ** 2)[..., :2].sum(axis=-1)),
    /Users/philiploche/repos/lab-cosmo/torch-pme/examples/4-kspace-demo.py:192: DeprecationWarning: __array_wrap__ must accept context and return_scalar arguments (positionally) in the future. (Deprecated NumPy 2.0)
      np.exp(-4 * ((cell[0, 0] / 2 - xyz_mesh) ** 2)[..., [0, 2]].sum(axis=-1)),
    /Users/philiploche/repos/lab-cosmo/torch-pme/examples/4-kspace-demo.py:193: DeprecationWarning: __array_wrap__ must accept context and return_scalar arguments (positionally) in the future. (Deprecated NumPy 2.0)
      np.exp(-4 * ((cell[0, 0] / 2 - xyz_mesh) ** 2)[..., 1:].sum(axis=-1)),
...
.. image-sg:: /examples/images/sphx_glr_4-kspace-demo_002.png
   :alt: input values, filter 1, filter 2
   :srcset: /examples/images/sphx_glr_4-kspace-demo_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.colorbar.Colorbar object at 0x11d333a40>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Evaluation time:
    Pytorch: 72.39103317260742µs
    Jitted:  69.50855255126953µs
...
.. _sphx_glr_download_examples_4-kspace-demo.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: 4-kspace-demo.ipynb <4-kspace-demo.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: 4-kspace-demo.py <4-kspace-demo.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: 4-kspace-demo.zip <4-kspace-demo.zip>`
