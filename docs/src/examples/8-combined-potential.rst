...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_8-combined-potential.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_8-combined-potential.py:
...
.. chemiscope:: _datasets/fig_8-combined-potential_002.json.gz
            :mode: structure
...
.. image-sg:: /examples/images/sphx_glr_8-combined-potential_001.png
   :alt: 8 combined potential
   :srcset: /examples/images/sphx_glr_8-combined-potential_001.png
...
.. image-sg:: /examples/images/sphx_glr_8-combined-potential_002.png
   :alt: 8 combined potential
   :srcset: /examples/images/sphx_glr_8-combined-potential_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/images/sphx_glr_8-combined-potential_003.png
   :alt: 8 combined potential
   :srcset: /examples/images/sphx_glr_8-combined-potential_003.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_examples_8-combined-potential.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: 8-combined-potential.ipynb <8-combined-potential.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: 8-combined-potential.py <8-combined-potential.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: 8-combined-potential.zip <8-combined-potential.zip>`
