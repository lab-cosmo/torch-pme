...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_3-mesh-demo.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_3-mesh-demo.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <torch._C.Generator object at 0x11d337190>
...
.. chemiscope:: _datasets/fig_3-mesh-demo_002.json.gz
            :mode: structure
...
.. image-sg:: /examples/images/sphx_glr_3-mesh-demo_001.png
   :alt: $n_{\mathrm{grid}}=3$, $n_{\mathrm{grid}}=7$
   :srcset: /examples/images/sphx_glr_3-mesh-demo_001.png
...
.. chemiscope:: _datasets/fig_3-mesh-demo_003.json.gz
            :mode: structure
...
.. chemiscope:: _datasets/fig_3-mesh-demo_004.json.gz
            :mode: structure
...
.. image-sg:: /examples/images/sphx_glr_3-mesh-demo_002.png
   :alt: 3 mesh demo
   :srcset: /examples/images/sphx_glr_3-mesh-demo_002.png
   :class: sphx-glr-single-img
...
.. chemiscope:: _datasets/fig_3-mesh-demo_005.json.gz
            :mode: structure
...
.. image-sg:: /examples/images/sphx_glr_3-mesh-demo_003.png
   :alt: 3 mesh demo
   :srcset: /examples/images/sphx_glr_3-mesh-demo_003.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_examples_3-mesh-demo.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: 3-mesh-demo.ipynb <3-mesh-demo.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: 3-mesh-demo.py <3-mesh-demo.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: 3-mesh-demo.zip <3-mesh-demo.zip>`
