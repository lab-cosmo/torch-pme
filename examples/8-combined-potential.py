...
:Authors: Michele Ceriotti `@ceriottm <https://github.com/ceriottm/>`_; 
    Egor Rumiantsev `@E-Rum <https://github.com/E-Rum>`_

This notebook demonstrates the use of the :py:class:`CombinedPotential
<torchpme.lib.CombinedPotential>`
class to evaluate potentials that combine 
multiple pair potentials with optimizable weights.
"""
...
import torchpme
from torchpme.lib.potentials import CoulombPotential, CombinedPotential
...
# ----
#
# This is just a stub based on the splined-potential demo.
# I'd like to see 
#
# * Construction of the potential as sum of multiple terms
# * Plot of the CombinedPotential functions being the combination
#   of each term
# * Example of use in a PMECalculator, maybe including optimization
#   and using the metatensor interface for a change
#
#
# BELOW IS JUST THE OLD FILE TO PROVIDE CODE SNIPPETS
# %%
