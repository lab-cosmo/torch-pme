...
class FourierSpaceConvolution:
    ...
    def compute(self, mesh_values: torch.Tensor,
        ...
        G = self.kernel_func(knorm_sq, potential_exponent=potential_exponent, smearing=smearing)
        G[0,0,0] = self.value_at_origin(potential_exponent=potential_exponent, smearing=smearing)
